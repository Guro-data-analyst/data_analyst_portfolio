...
-- =============================================================
-- 2. Средний чек с комисси за доставку
-- =============================================================
...
-- =============================================================
-- 4. CR в размещениие заказа за ма-июнь 2021
-- =============================================================
SELECT log_date,
...
-- =============================================================
-- 5. Топ-3 ресторана с max LTV по суммарной комиссии
-- =============================================================
-- Рассчитываем величину комиссии с каждого заказа, отбираем заказы по дате и городу
WITH orders AS
...
-- =============================================================
-- 6. Топ-5 блюд с  max LTV по суммарной комиссии из ТОП-3 ресторана
-- =============================================================
...
-- =============================================================
-- 7. RR первой недели после регистрациии
-- =============================================================
-- Рассчитываем новых пользователей по дате первого посещения продукта
WITH new_users AS
  (SELECT DISTINCT first_date,
